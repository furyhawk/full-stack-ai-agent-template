...
|----------|---------|-------------|
| `PROJECT_NAME` | `ai_agent_4` | Display name for the project |
...
| `POSTGRES_DB` | `ai_agent_4` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `ai_agent_4` | Service name in Logfire dashboard |
...
| `S3_RAG_BUCKET` | `ai_agent_4-rag` | Bucket name |
