...
class Settings(BaseSettings):
    ...
    LOGFIRE_SERVICE_NAME: str = "ai_agent_4"
    ...
    S3_RAG_BUCKET: str = "ai_agent_4-rag"
    ...
    EMAIL_FROM: str = "noreply@ai_agent_4.com"
    EMAIL_FROM_NAME: str = "ai_agent_4"
